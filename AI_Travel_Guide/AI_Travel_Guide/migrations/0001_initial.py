    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.CharField(help_text='Name of the destination.', max_length=100)),
                ('start_date', models.DateField()),
                ('end_date', models.DateField()),
                ('budget', models.DecimalField(decimal_places=2, help_text='Budget allocated for this trip.', max_digits=10)),
                ('distance', models.FloatField(help_text='Distance to the destination (in km).')),
                ('packing_checklist', models.TextField(blank=True, help_text='Dynamic packing checklist for the trip.', null=True)),
                ('real_time_alerts', models.TextField(blank=True, help_text='Real-time alerts related to the trip.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.DecimalField(decimal_places=2, help_text='Maximum budget for the trip.', max_digits=10)),
